...
<div class="headtitle">    
    <div class="btn-group">
        ...
        <ul class="dropdown-menu">
            <li>
                <a href="{{ route('libur.tambah') }}"><i class="iconfa-plus-sign"></i>&nbsp;Tambah Libur</a>
            </li>
        </ul>
    </div>
    <h4 class="widgettitle">Tabel List Libur</h4>
