...
<div class="headtitle">    
    <div class="btn-group">
        ...
        <ul class="dropdown-menu">
            <li>
                <a href="{{ route('perusahaan.tambah') }}"><i class="iconfa-plus-sign"></i>&nbsp;Tambah Perusahaan</a>
            </li>
        </ul>
    </div>
    <h4 class="widgettitle">Tabel List Perusahaan</h4>
