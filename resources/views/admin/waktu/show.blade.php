    ...
    App.prototype.table     = function(){
        ...
        this.dataTable = _this.DOM.tableId.DataTable({
            ...
            [
                ...
                { data    : "waktu_kode", name: "waktu_kode" },
                { data    : "waktu_masuk", name: "waktu_masuk" },
                { data    : "waktu_keluar", name: "waktu_keluar" },
                { data    : "pendek", name: "pendek" },
                { data    : "istirahat", name: "pendek" },
...
<div class="headtitle">    
    <div class="btn-group">
        ...
        <ul class="dropdown-menu">
            <li>
                <a href="{{ route('waktu.tambah') }}"><i class="iconfa-plus-sign"></i>&nbsp;Tambah Waktu</a>
            </li>
        </ul>
    </div>
    <h4 class="widgettitle">Tabel List Waktu</h4>
