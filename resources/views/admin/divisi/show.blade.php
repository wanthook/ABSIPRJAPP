...
@section('pageheader')
<div class="pageicon"><span class="iconfa-random"></span></div>
<div class="pagetitle">
    <h5>List Master Divisi</h5>
    <h1>Divisi</h1>
</div>
@endsection
...
<div class="headtitle">    
    <div class="btn-group">
        ...
        <ul class="dropdown-menu">
            <li>
                <a href="{{ route('divisi.tambah') }}"><i class="iconfa-plus-sign"></i>&nbsp;Tambah Divisi</a>
            </li>
        </ul>
    </div>
    <h4 class="widgettitle">Tabel List Divisi</h4>
