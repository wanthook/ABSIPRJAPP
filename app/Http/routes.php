...
Route::group(['middleware' => ['web','auth']], function ()  use ($ext){
     ...
     */
    Route::get('jadwal',                ['as' => 'jadwal.tabel','uses'  => 'JadwalController@show']);
    Route::post('jadwal',               ['as' => 'jadwal.tabel','uses'  => 'JadwalController@dataTables']);
    Route::get('jadwal/tambah/dayshift',['as' => 'jadwal.tambah.dayshift','uses' => 'JadwalController@create_dayshift']);
    Route::post('jadwal/tambah/dayshift',      ['as' => 'jadwal.tambah.dayshift','uses' => 'JadwalController@save_dayshift']);
    Route::patch('jadwal/ubah/{id}/dayshift',    ['as' => 'jadwal.ubah.dayshift','uses'   => 'JadwalController@update_dayshift']);
    Route::get('jadwal/ubah/{id}/dayshift',      ['as' => 'jadwal.ubah.dayshift','uses'   => 'JadwalController@edit_dayshift']);
    
    Route::get('jadwal/tambah/shift',['as' => 'jadwal.tambah.shift','uses' => 'JadwalController@create_shift']);
    Route::post('jadwal/tambah/shift',['as' => 'jadwal.tambah.shift','uses' => 'JadwalController@save_shift']);
    Route::patch('jadwal/ubah/{id}/shift',    ['as' => 'jadwal.ubah.shift','uses'   => 'JadwalController@update_shift']);
    Route::get('jadwal/ubah/{id}/shift',      ['as' => 'jadwal.ubah.shift','uses'   => 'JadwalController@edit_shift']);
    
    Route::patch('jadwal/{id}/hapus',   ['as' => 'jadwal.hapus','uses'   => 'JadwalController@softdelete']);
    //for select2
    Route::post('jadwal/selectdua',        ['as' => 'jadwal.selectdua','uses' => 'JadwalController@selectdua']);
    //fortablecalendar
    Route::post('jadwal/calendar',        ['as' => 'jadwal.calendar','uses' => 'JadwalController@calendar']);
});
